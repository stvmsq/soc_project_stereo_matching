...
#
# stereo_matching_software.tcl: Tcl script for re-creating project 'stereo_matching_software'
#
# Generated by Vivado on Fri Dec 12 12:13:20 CET 2025
...
#
# 1. This project restoration tcl script (stereo_matching_software.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/stefan/Coding/Docker/xilinx/data/soc_project_stereo_matching/ZedBoard/Vivado/stereo_matching_software.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/stereo_matching_software.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "stereo_matching_software"
...
set script_file "stereo_matching_software.tcl"
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/stereo_matching_software.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
